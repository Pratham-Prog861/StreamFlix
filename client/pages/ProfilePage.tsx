      ...
      <div className="flex flex-col md:flex-row items-center md:items-start text-center md:text-left">
        <div className="relative group flex-shrink-0">
          <img
            src={
              isEditing
                ? editData.avatar || 'https://picsum.photos/seed/user/200'
          ...
          {isEditing ? (
            <div className="space-y-4 max-w-sm mx-auto md:mx-0">
              ...
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm font-bold text-gray-400 mb-1 text-left"
                >
                  Name
                </label>
                <input
              ...
              <div>
                <label className="block text-sm font-bold text-gray-400 mb-2 text-left">
                  Avatar
                </label>
              ...
              <div className="flex space-x-4 pt-4">
                <button
                  ...
                  disabled={saving}
                  className="bg-red-600 text-white font-bold py-2 px-6 rounded hover:bg-red-700 transition duration-300 flex-1 disabled:bg-gray-600"
                >
            ...
            <>
              ...
              {user.role === 'admin' && (
                <span className="inline-block mt-2 bg-red-600 text-white text-xs font-bold px-3 py-1 rounded">
                  ADMIN
                </span>
              )}
              <button
                onClick={handleEditClick}
                className="mt-6 bg-red-600 text-white font-bold py-2 px-6 rounded hover:bg-red-700 transition duration-300"
              >
                Edit Profile
              </button>
            </>
